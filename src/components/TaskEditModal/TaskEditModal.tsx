...
const TaskEditModal: FC<TaskEditModalProps> = ({ isActive, setIsActive, setTaskTitleProp, columnId, taskId }) => {
  ...
  useEffect(() => {
    isActive && getTaskData(currentBoard._id, columnId, taskId);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateTask(currentBoard._id, columnId, columnId, taskId, taskTitle, taskOrder, description, taskUser);
    setIsActive(false);
